...
public class RAIDistantResourcesTournament extends RAITournament {
    public RAIDistantResourcesTournament(List<AI> AIs) {
        super(AIs);
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        var tournament = new RAIDistantResourcesTournament(Arrays.asList(AIs));
